...
//    cp.X(1.52); Causes errors
    ...
    // create the circle
    Circle test_circle(p1.Distance(p2), p1);
    
    std::cout << "The Radius is: " << test_circle.Radius() << std::endl;
    std::cout << "The Diamater is: " << test_circle.Diamater() << std::endl;
    std::cout << "The Area is: " << test_circle.Area() << std::endl;
    std::cout << "The Circumference is: " << test_circle.Circumference() << std::endl;
