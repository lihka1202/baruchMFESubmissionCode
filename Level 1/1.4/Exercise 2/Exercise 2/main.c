...
int main(int argc, const char * argv[]) {
    ...
    // ON xcode and macos, I need to press ctrl d twice, and due to the way the loop is structured, this gets counted as a character, does not happen in the while version.
    count_of_characters -= 1;
